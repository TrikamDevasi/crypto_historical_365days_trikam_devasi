    ...
    <div className="min-h-screen bg-bg-primary text-white flex relative overflow-hidden font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 w-full min-h-screen">
        ...
        <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 bg-bg-secondary/40 border-r border-white/5 relative overflow-hidden">
          ...
          <div className="absolute -top-40 -left-40 w-96 h-96 rounded-full bg-accent/20 blur-[100px] pointer-events-none" />
          <div className="absolute -bottom-40 -right-40 w-96 h-96 rounded-full bg-primary/20 blur-[100px] pointer-events-none" />

          {/* Logo */}
          <div className="flex items-center gap-2.5 z-10">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-primary to-accent flex items-center justify-center shadow-neon-primary/20 shadow-md">
          ...
          <div className="flex-1 flex flex-col items-center justify-center z-10">
            <FloatingCoin size={260} color="#00d4ff" className="drop-shadow-neon-primary" />
        ...
        <div className="col-span-1 lg:col-span-7 flex items-center justify-center p-6 sm:p-12 relative">
          <div className="absolute top-40 right-20 w-80 h-80 rounded-full bg-accent/15 blur-[120px] pointer-events-none" />
          <div className="absolute bottom-40 left-20 w-80 h-80 rounded-full bg-primary/15 blur-[120px] pointer-events-none" />
