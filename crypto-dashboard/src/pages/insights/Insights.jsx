  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {/* Highest Price */}
        {highestPrice && (
          <Card className="p-5 border-l-[3px] border-accent-cyan flex items-center justify-between">
            <div>
            ...
            <div className="text-right">
              <span className="font-mono font-bold text-xl text-accent-cyan">{formatCurrency(highestPrice.price, 2)}</span>
        ...
        {/* Lowest Price */}
        {lowestPrice && (
          <Card className="p-5 border-l-[3px] border-accent-purple flex items-center justify-between">
            <div>
            ...
            <div className="text-right">
              <span className="font-mono font-bold text-xl text-accent-purple">{formatCurrency(lowestPrice.price, 4)}</span>
